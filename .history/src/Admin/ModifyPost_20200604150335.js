        ...
        <div>
            <Form name="basic" onFinish={onFinish} onFinishFailed={onFinishFailed}>
                ...
                <Col className="gutter-row" span={12} offset={6}>
                    <Form.Item value={title} name="title" onChange={this.changeHandler} rules={[{ required: true, message: 'Le titre n\'a pas été entrer', },]}>
                        <Input />
                    </Form.Item>
                    ...
                    <br />
                    <br />
                    <Form.Item name='content' value={content} onChange={this.changeHandler}>
