...
const ModifyPost = () => {
    ...
    const [description, setDescription] = useState('Mon contenue');
    const [slug, setSlug] = useState('Mon contenue');
        ...
        <div>
            <Form name="basic" onFinish={onFinish} onFinishFailed={onFinishFailed}>
                <Col className="gutter-row" span={12} offset={6}>
                    ...
                    <br />
                    <Form.Item name="title" value={title} onChange={value => setDescription(value)} rules={[{ required: true, message: 'Le titre n\'a pas été entrer', },]}>
                        <Input />
                    </Form.Item>
                    <span>Slug</span>
                    <br />
                    <Form.Item name="title" value={title} onChange={value => setSlug(value)} rules={[{ required: true, message: 'Le titre n\'a pas été entrer', },]}>
                        <Input />
                    </Form.Item>
