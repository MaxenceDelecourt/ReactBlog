                            ...
                            <Card style={{ width: '100%', borderRadius: '30px' }}>
                                <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                                    <Col className="gutter-row" span={6}>
                                        ...
                                        <Form.Item rules={[{ required: true, message: 'La date n\'a pas été séléctionné', },]}>
                                    ...
                                    <Col className="gutter-row" span={12}>
                                        ...
                                        <br />
                                        <Form.Item name='content' value={content} onChange={(value) => this.setState({ content: value })} rules={[{ required: true, message: 'Le contenue n\'a pas été séléctionné', },]}>
