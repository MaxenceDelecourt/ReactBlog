        ...
        <div>
            <Form name="basic" onFinish={onFinish} onFinishFailed={onFinishFailed}>
                <Col className="gutter-row" span={12} offset={6}>
                    ...
                    <br />
                    <Form.Item name="description" value={description} onChange={value => setDescription(value)} rules={[{ required: true, message: 'Le titre n\'a pas été entrer', },]}>
                        <Input />
                    </Form.Item>
                    <span>Slug</span>
                    <br />
                    <Form.Item name="slug" value={slug} onChange={value => setSlug(value)} rules={[{ required: true, message: 'Le titre n\'a pas été entrer', },]}>
                        <Input />
                    </Form.Item>
                    ...
                    <br />
                    <span>Date de publication : </span><DatePicker name="date" value={date} onChange={value => setDate(value)}/>
                    <br />
                    <br />
