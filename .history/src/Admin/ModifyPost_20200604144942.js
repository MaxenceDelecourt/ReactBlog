import React, {useState, submitHandler, changeHandler} from 'react';
...
const ModifyPost = () => {
    ...
    return (
        <div>
            <Form name="basic" onSubmit={this.submitHandler} onFinish={onFinish} onFinishFailed={onFinishFailed}>
