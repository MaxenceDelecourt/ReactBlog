          ...
          <div className="site-layout-content">
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              <Col className="gutter-row" span={2}>
                <img src={Manage} style={{ width: '100px' }} />
              </Col>
              <Col className="gutter-row" span={10}>
                <Title level={2}>Bienvenue sur la gestion de vos article</Title>
              </Col>
            ...
            <Modal width={typeModal ? '' : '520'} visible={visible} onOk={() => this.handleOk(dataSource[index].id)} confirmLoading={confirmLoading} cancelText='annuler' onCancel={() => this.handleCancel()}>
              {typeModal
