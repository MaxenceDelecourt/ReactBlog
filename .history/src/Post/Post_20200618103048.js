    ...
    if (post) {
      ...
      const columns = [
        ...
        },
        {
          ...
          dataIndex: '',
          key: 'x',
          render: () => <Button type="primary" shape="round" size={size}>
            <Link to={'/PostDescription/' + dataSource.slug}>Accéder à l'article</Link>
          </Button>
        },
        {
          title: 'date',
        ...
        },
        {
          ...
          render: () =>
            <div>
              ...
              <Modal visible={visible} onOk={() => this.handleOk(dataSource.id)} confirmLoading={confirmLoading} cancelText='annuler' onCancel={() => this.handleCancel('1')}>
              ...
              <Modal visible={visible2} onOk={() => this.handleOk(dataSource.id)} confirmLoading={confirmLoading} cancelText='annuler' onCancel={() => this.handleCancel('2')}>
                <ModifyPost title={dataSource.title} description={dataSource.description} slug={dataSource.slug} content={dataSource.content} date={dataSource.date} />
              </Modal>
            </div>
        },
      ]
