...
import { FormOutlined, ConsoleSqlOutlined } from '@ant-design/icons';
              ...
              <Col className="gutter-row" span={6}>
                <Card style={{ width: 240 }} cover={<img key={currentPost.id} />}>
                  ...
                  <div>
                    ...
                    <Modal visible={visible} onOk={() => this.handleOk(currentPost.id)} confirmLoading={confirmLoading} onCancel={this.handleCancel}>
                      <p>{ModalText}</p>
                    </Modal>
                  </div>
                </Card>
