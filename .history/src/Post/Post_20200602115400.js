...
class Post extends Component {
  ...
  render() {
    ...
    if (error !== null) {
      return <Result status="500" title="500" subTitle="Sorry, something went wrong." extra={<Button type="primary"><Link to={'/PostDescription/' + currentPost.id}>Accéder à l'article</Link>
