            ...
            render: (index) =>
              <div>
                <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                  <Col span={12}>
                    <Button type="primary" shape="round" size={size} danger onClick={() => this.showModal(index)}>
                      <DeleteOutlined />supprimer
                    </Button>
                  </Col>
                  <Col span={12}>
                    <Button style={{ backgroundColor: '#52c41a', color: 'white' }} shape="round" size={size} onClick={() => this.showModal(index)}>
