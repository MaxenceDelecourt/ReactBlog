...
import { Typography, Card, Button, Row, Col, Spin, Space, Pagination, Result, Modal, AutoComplete, Input } from 'antd';
...
class Post extends Component {
  ...
  handleSearch = value => {
    this.setOptions(value ? this.searchResult(value) : []);
  };
          ...
          <div className="site-layout-content">
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              ...
              <Col className="gutter-row" span={4}>
                <AutoComplete dropdownMatchSelectWidth={252} style={{ width: 300, }} options={this.options} onSelect={this.onSelect} onSearch={this.handleSearch}>
