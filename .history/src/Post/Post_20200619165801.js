      ...
      if (error !== null) {
        ...
        return (
          <div className="site-layout-content">
            ...
            <Modal width={typeModal ? '' : '300'} visible={visible} onOk={() => this.handleOk(dataSource[index].id)} confirmLoading={confirmLoading} cancelText='annuler' onCancel={() => this.handleCancel()}>
              {typeModal
