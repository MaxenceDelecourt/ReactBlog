...
export const createClient = {
    ...
    postArticle: async function (values) {
        postCategorie: async function (values) {
            let response = await this.client().getSpace(config.space)
            let createResponse = await response.createEntry(‘category’, {
        // Create entry
