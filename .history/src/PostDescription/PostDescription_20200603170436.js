...
import {Space, Spin, Typography, Avatar } from 'antd'
    ...
    async componentDidMount() {
        ...
        if (result === 'error') {
            ...
            this.setState({ 
                ...
                avatar: result.items[0].fields.author.fields.avatar.field.file.url,
        ...
        if (error !== null) {
            ...
            return (
                <div className="site-layout-content">
                    ...
                    <br/>
                    <div>{content}</div>
                    <div>Publié par : <Avatar src={avatar}/> {author}, créé le {date}</div>
                </div>
            );
        }
    }
