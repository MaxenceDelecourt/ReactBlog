...
import {Space, Spin, Typography, Avatar, Card } from 'antd'
        ...
        if (error !== null) {
            ...
            return (
                <div className="site-layout-content">
                    <Title>{title}</Title>
                    <br/>
                    <Card style={{borderRadius: '15px'}}>{content}</Card>
                    <div>Publié par  <Avatar size='large' src={avatar}/>    {author}, créé le {date}</div>
                </div>
            );
        }
    }
